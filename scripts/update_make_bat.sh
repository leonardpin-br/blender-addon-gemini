...
# Changing it to the full path of the build_sphinx_blender_doc.py file.
#
...
update_make_bat() {
    ...
    # Builds the new line.
    CONFIG_FILE="${CONFIG_FILE}\tset SPHINXBUILD=blender --background --python \"${DOCUMENTATION_CONFIG_DIR}/build_sphinx_blender_doc.py\""
